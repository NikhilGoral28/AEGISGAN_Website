...
export default function ModelOverview() {
  return (
    <div className="min-h-screen bg-[#020617] text-white pt-24 pb-12 px-6 lg:px-20 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {/* Base Model */}
          <div className="bg-cardDeep border border-white/10 p-8 rounded-2xl shadow-lg hover:border-accentCyan/30 transition-colors">
            <div className="flex items-center gap-4 mb-4">
              <div className="p-3 bg-accentCyan/10 rounded-lg text-accentCyan">
                <Cpu size={32} />
              </div>
              <h2 className="text-2xl font-bold">Base Model Architecture</h2>
            </div>
          ...
          {/* Generative Model */}
          <div className="bg-cardDeep border border-white/10 p-8 rounded-2xl shadow-lg hover:border-accentOrange/30 transition-colors">
            <div className="flex items-center gap-4 mb-4">
              <div className="p-3 bg-accentOrange/10 rounded-lg text-accentOrange">
                <Activity size={32} />
              </div>
              <h2 className="text-2xl font-bold">WCGAN-GP for Data Generation</h2>
            </div>
            <p className="text-slate-300 leading-relaxed">
        ...
        {/* Datasets */}
        <div className="bg-cardDeep border border-white/10 p-8 rounded-2xl shadow-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="p-6 bg-white/5 border border-white/5 rounded-xl">
              <h3 className="text-xl font-bold text-white mb-2">UNSW-NB15</h3>
            ...
            <div className="p-6 bg-white/5 border border-white/5 rounded-xl">
              <h3 className="text-xl font-bold text-white mb-2">NSL-KDD</h3>
              <p className="text-slate-400 text-sm">
        ...
        {/* System Architecture */}
        <div className="bg-cardDeep border border-white/10 p-8 rounded-2xl shadow-lg mt-12">
          <div className="flex items-center gap-4 mb-8">
            <div className="p-3 bg-purple-500/10 rounded-lg text-purple-400">
              <ShieldCheck size={32} />
            </div>
            <h2 className="text-2xl font-bold">System Pipeline & Modules</h2>
          </div>
          ...
          <div className="space-y-6">
            <div className="p-6 bg-white/5 border border-white/5 rounded-xl hover:border-purple-500/30 transition-colors">
              <h3 className="text-xl font-bold text-white mb-2">1. Traffic Capture</h3>
            ...
            <div className="p-6 bg-white/5 border border-white/5 rounded-xl hover:border-purple-500/30 transition-colors">
              <h3 className="text-xl font-bold text-white mb-2">2. Bridge & Stream</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="p-6 bg-white/5 border border-white/5 rounded-xl hover:border-purple-500/30 transition-colors">
              <h3 className="text-xl font-bold text-white mb-2">3. Feature Engineering</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="p-6 bg-white/5 border border-white/5 rounded-xl hover:border-purple-500/30 transition-colors">
              <h3 className="text-xl font-bold text-white mb-2">4. Detection Engine</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="p-6 bg-white/5 border border-white/5 rounded-xl hover:border-purple-500/30 transition-colors">
              <h3 className="text-xl font-bold text-white mb-2">5. SOC Dashboard</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
